#!/usr/bin/env python3
"""
Daily YouTube ingestion for HealthyGamerGG channel using YouTube Transcript API
...
def fetch_transcript(video_id, title):
    ...
    try:
        ...
        return {"success": True, "data": {"transcript": formatted_transcript}}
...
- **Method:** YouTube Transcript API integration
"""
...
def main():
    ...
    for i, video in enumerate(selected_videos, 1):
        ...
        # Fetch transcript
        result = fetch_transcript(video_id, title)
