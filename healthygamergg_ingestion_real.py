#!/usr/bin/env python3
"""
HealthyGamerGG YouTube Ingestion Pipeline with Real Video Data
...
class HealthyGamerGGIngestion:
    ...
    def fetch_transcript(self, video_id: str, video_title: str) -> Optional[str]:
        """Fetch transcript for a video using TranscriptAPI."""
        ...
        try:
            ...
            response = requests.post(api_url, headers=headers, json={"format": "text"})
