...
domain: biotech
tags: [neuroscience, REM-sleep, sleep, brain-metabolism]
...
Rapid eye movement (REM) sleep is a distinct sleep stage characterized by prominent theta-band (6–9 Hz) EEG/ECoG activity, low muscle tone (atonia), and vivid dreaming. During REM sleep, the brain exhibits unique metabolic and vascular dynamics that differ fundamentally from NREM sleep and wakefulness.
...
- This contrasts with NREM's faster anterior-to-posterior vascular waves
