...
domain: laboratory
tags: [quality-control, quality-management, laboratory, clia]
sources: []
confidence: high
status: active
reviewed: 2026-07-31
...
**Quality control (QC)** in the clinical laboratory refers to the set of procedures used to monitor and verify the accuracy and precision of analytical test results on a day-to-day basis. QC processes detect, evaluate, and correct systematic and random errors before patient results are released, ensuring that laboratory performance meets accepted standards.

## Key Points

- **Control materials** with known values are analyzed alongside patient samples to detect analytical drift or shift.
- **Statistical control charts** (e.g., Levey-Jennings plots) track control results against established mean and standard deviation limits.
