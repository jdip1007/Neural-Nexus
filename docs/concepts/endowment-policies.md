...
**Endowment policies** are life insurance contracts with fixed maturity dates that pay out a lump sum either at maturity or on death. Similar to savings insurance but with a defined end date.
