...
- Aggregates are toxic to neurons
...
- Selective vulnerability of specific populations
- Irreversible damage
...
**Mechanisms:**
- Toxic protein effects on synapses
- Glial dysfunction
...
**Dual role:**
- Initially protective (clearance of debris)
- Becomes detrimental (chronic damage)
...
- Widespread cortical and hippocampal atrophy
...
- Non-motor symptoms (cognitive, autonomic)
...
**Pathology:**
- CAG repeat expansion in huntingtin gene
...
- Midlife obesity increases risk of Alzheimer's and Parkinson's
- Higher BMI associated with faster cognitive decline
- Visceral adiposity particularly harmful

**Mechanisms:**
1. **Systemic inflammation:** Cytokines cross BBB, activate microglia
2. **Insulin resistance:** Impaired neuronal metabolism
3. **Vascular dysfunction:** Reduced cerebral blood flow
4. **BBB breakdown:** Immune cell infiltration
5. **Glymphatic impairment:** Reduced waste clearance

**Convergent-cascade model:**
- Obesity creates multiple parallel disruptions
- Interactions create emergent vulnerabilities
- Regional differences in resilience determine where degeneration manifests
...
- Worsened Alzheimer's pathology
...
**Consequences:**
- Energy deficits in active neurons
- Metabolic stress
...
**Genetics:**
- APOE4 (Alzheimer's)
- Mutations in familial forms
- Polygenic risk scores

**Age:**
- Primary risk factor for most neurodegenerative diseases
- Cumulative damage over time

**Sex:**
- Some diseases show sex differences
- Hormonal influences
...
- Tau PET (Alzheimer's)
- Dopamine transporter PET (Parkinson's)
- Glucose metabolism (FDG-PET)

### Fluid Biomarkers

**CSF:**
- Aβ42 (decreased in Alzheimer's)
- Phospho-tau (increased in Alzheimer's)
...
- Target amyloid plaques in Alzheimer's
- Show modest clinical benefit

**Anti-tau therapies:**
- In development
- Target tau aggregation and spread

**Gene therapies:**
- Huntington's disease (gene silencing)
...
- Neurodegenerative diseases are progressive and currently incurable
- Protein aggregation is a common pathological feature
- Metabolic disorders, especially obesity, are major modifiable risk factors
- Neurovascular unit dysfunction is increasingly recognized as central to pathogenesis
- Early intervention before symptom onset may be most effective
