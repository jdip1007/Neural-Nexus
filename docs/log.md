...
- Updated youtube-transcript-batch-wiki skill for Neural Nexus integration
- Processed 5 high-priority legal case videos from DangerousPerson2.0 channel:
  - [EP145] Tuen Mun Rapist Case (林國偉) - First DNA evidence case in Hong Kong
  - [EP146] Kwai Chung Police Dormitory Quadruple Murder - Most terrifying Hong Kong case
  - [EP147] Celebrity Blackmail Case ("X先生黃腳雞案") - High-profile extortion scheme
  - [EP148] Fuk New Village Seven Murders - Complex criminal investigation
  - [EP149]观音兵 Hunter Case - Sophisticated criminal investigation
- Created comprehensive finding pages:
  - [tuen-mun-rapist-case-analysis](findings/tuen-mun-rapist-case-analysis.md) - Psychological analysis and DNA evidence breakthrough
  - [kwai-chung-police-dormitory-murder](findings/kwai-chung-police-dormitory-murder.md) - Domestic violence and police corruption case
  - [celebrity-blackmail-case](findings/celebrity-blackmail-case.md) - Celebrity extortion and confidence games
- Created research overview page:
  - [dangerous-person-2-0-research-overview](concepts/dangerous-person-2-0-research-overview.md) - Comprehensive research methodology and findings
- Updated findings index with new content and cross-references
- Transcribed 8,341 lines of video content across 5 videos
- Applied proper frontmatter with Neural Nexus schema compliance
- Integrated with existing Hong Kong legal system concepts
- Key insights: DNA evidence evolution, criminal psychology patterns, media impact on legal cases
...
- Graph built: comprehensive DNA extraction and sequencing knowledge network
- Source files: 15 raw articles from processed PDF documents
...
- Graph built: 8 nodes, 18 edges
- Source file: raw/articles/knowledge-preservation-big-science-ai-rainford-et-al-2026.md
- Key insights: AI integration challenges, reproducibility crisis, knowledge preservation strategies

## [2026-07-18] fix | Lint compliance improvements
- Added frontmatter to reference pages (setup-guide.md, writing-guide.md)
- Fixed invalid tags in SCHEMA.md taxonomy
- Updated wikilinks to use correct relative paths
- Added reviewed dates to all pages
- Graph now builds with 3 nodes and 4 edges
