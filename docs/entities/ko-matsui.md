...
domain: biotech
tags: [neuroscience, researcher, tohoku-university, glial-biology, brain-physiology]
...
- **Position**: Professor, Super-network Brain Physiology, Graduate School of Life Sciences and Graduate School of Medicine, Tohoku University
...
- **Key contributions**: 
  ...
  - Glial tone of aggression (Asano et al., 2024)
  - Local brain environment changes associated with epileptogenesis (Ikoma, Sasaki & Matsui, 2022)

## Research Themes

- **Astrocyte function**: How astrocytes modulate neural circuits and information processing
- **Brain energy dynamics**: State-dependent energy metabolism in neurons and astrocytes
- **Glial decoding**: Understanding how glial cells decode and influence neural computation
- **Epileptogenesis**: How local brain environment changes contribute to seizure development
