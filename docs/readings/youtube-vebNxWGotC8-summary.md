...
## TL;DR
This video discusses FBI vs CIA - How Do They Compare?

## Key Points
- **The**: The CIA’s main concerns are terrorism, weapons
of mass destruction, knowing what dangers or political upheavals are happening around
the world – this could be called spying – and more recently cyber-intelligence
- **One**: One of the main impetuses to create such an
agency was the attack on Pearl Harbor
- **One**: One important matter when working for the
CIA is secrecy if you are an agent
- **As**: As its website points out in bold as IMPORTANT:
“Friends, family, individuals, or organizations may be interested to learn that you are an
applicant for or an employee of the CIA
- **”**: ” The FBI won’t involve the stress of remaining
a kind of mystery to one’s own friends and loved ones
