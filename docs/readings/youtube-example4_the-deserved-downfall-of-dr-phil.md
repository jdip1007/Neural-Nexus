...
tags: ["social_media"]
sources: [raw/youtube/example4_the-deserved-downfall-of-dr-phil.md]
confidence: high
status: active
reviewed: 2026-09-15
backlinks: []
...
**Source**: https://www.youtube.com/watch?v=example4  
**Video ID**: example4  
**Channel**: Internet Anarchist (@InternetAnarchist)  
**Processed**: 2026-09-15 01:10:52  
...
In this video, we explore the downfall of Dr Phil.
